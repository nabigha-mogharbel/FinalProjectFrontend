...
function PassengerTrip() {
  ...
  return (
    <div className="tripList">
      <Button className="self-start ml-4">
      ...
      {!isLoading && trip !== null && (
        <>
        <h1 className="flex items-center gap-2 p-0 m-0">
          ...
          <div className=" flex flex-column align-start w-11/12">
            ...
            <div className="flex justify-start gap-4 ml-4">
              ...
              <State state={trip.tripStatus} text={trip.busStatus} />
            </div>
            <div className="flex justify-start gap-4 ml-4 mt-4">
              <div className="flex self-start gap-2 align-baseline">
                <svg
                  width="30"
                  height="20"
                  viewBox="0 0 40 28"
